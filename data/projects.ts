...
export const projects: Project[] = [
  ...
  category: "client",
  oneLiner:
    "An agentic AI you can actually try, right here. Same architectural pattern as the HEART AI I built for a paid engagement.",
  summary:
  ...
  outcomes: [
    ...
    "Architecture mirrors the HEART AI I built for a paid engagement — same closed-boundary, tool-routing pattern.",
  ],
  ...
  },
  {
    ...
    category: "client",
    oneLiner: "Part-time Data Analyst at an early-stage startup whose app reached ~50,000 MAU within months of launch.",
    summary:
      "Part-time Data Analyst (2022–23) alongside his BSc, at an early-stage startup whose app reached roughly 50,000 monthly active users within months of launch — a team/company outcome, not his individual metric. Built a Python hybrid recommendation system (collaborative + content-based) for the app's BITS short-form feature, and co-authored an internal, unpublished research paper on the methodology.",
    tags: ["Python", "Machine Learning", "Recommendation Systems", "Behaviour Analytics"],
    metrics: [
      { label: "Role", value: "Part-time, 2022–23" },
      { label: "App reach (team outcome)", value: "~50,000 MAU" },
    ],
    problem:
    ...
    approach: [
      ...
      "Co-authored an internal, unpublished research paper documenting the recommender's methodology — never released publicly.",
      "Integrated the OpenAI GPT API (Davinci, Babbage, Ada, GPT-3.5 Turbo) for an in-app Q&A chatbot, during the early ChatGPT era.",
      "Ran Power BI reporting and behaviour analytics (Google Analytics, Hotjar, Microsoft Clarity) to inform product decisions.",
    ],
    stack: ["Python", "Pandas", "scikit-learn", "OpenAI API", "Power BI", "Google Analytics", "Hotjar", "Microsoft Clarity"],
    outcomes: [
      "The app reached roughly 50,000 monthly active users within months of launch — a team/company outcome, not an individually attributed metric.",
      "Hybrid recommender (collaborative + content-based) shipped for the BITS short-form feature.",
      "Co-authored an internal, unpublished research paper on the methodology — never released publicly.",
      "Part-time role alongside a full-time BSc.",
    ],
  },
  {
    slug: "alzheimers-mri",
